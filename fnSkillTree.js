...
function generateSkillTree() {
  ...
  addSkill(skillTree,"","",0,"Checkpoint Block","",0,["採掘者","開拓者","生産者"],false,"root")
  ...
  addSkill(skillTree,"鉱夫","Coal",5,"Coal","Coal",100,["炭鉱夫","鉄鉱夫"])
  addSkill(skillTree,"宝石収集家","Diamond",25,"Diamond","Diamond",10,["招き猫","鑑定家","月へ"])
  ...
  addSkill(skillTree,"炭鉱夫","Coal",10,"Coal","Coal",800,["炭屋"])
  addSkill(skillTree,"鉄鉱夫","Raw Iron",15,"Iron Ore","Raw Iron",500,["深層鉱夫"])
  addSkill(skillTree,"招き猫","Raw Gold",20,"Gold Fragment","Gold Bar",400,["富豪"])
  addSkill(skillTree,"鑑定家","Diamond",50,"Diamond","Diamond",200,["宝石職人"])
  addSkill(skillTree,"月へ","Moonstone",75,"Moonstone","Moonstone",75,["宇宙飛行士"])
  ...
  addSkill(skillTree,"整地師","Dirt",2,"Stone Spade","Dirt",3000,["ベテラン整地師"])
  addSkill(skillTree,"小麦農家","Wheat",3,"Wheat","Wheat",1000,["prestage"])
  ...
  addSkill(skillTree,"炭屋","Coal",15,"Block of Coal","Coal",3000,["prestage"])
  addSkill(skillTree,"深層鉱夫","Raw Iron",25,"Block of Iron","Raw Iron",2000,["prestage"])
  addSkill(skillTree,"富豪","Raw Iron",50,"Block of Iron","Raw Gold",1200,["prestage"])
  addSkill(skillTree,"宝石職人","Diamond",100,"Block of Diamond","Diamond",400,["prestage"])
  addSkill(skillTree,"宇宙飛行士","Moonstone",150,"Yellowstone","Moonstone",150,["prestage"])
  addSkill(skillTree,"閃緑岩採掘者","Diorite",3,"Diorite","Granite",3000,["prestage"])
  ...
  addSkill(skillTree,"石を愛す者","Messy Stone",4,"Complessed Messy Stone","Messy Stone",6000,["石に愛された者"])
  addSkill(skillTree,"綿職人","Cotton",3,"Cotton","Cotton",2000,["prestage"])
  addSkill(skillTree,"きのこ農家","Brown Mushroom",3,"Brown Mushroom","Brown Mushroom",1000,["毒きのこがお好き?"])
  ...
  addSkill(skillTree,"ベテラン整地師","Dirt",3,"Iron Spade","Dirt",6000,["ロードローラー"])
  addSkill(skillTree,"にんじん農家","Carrot",3,"Carrot","Carrot",1000,["じゃがいも農家"])
  addSkill(skillTree,"スイカ農家","Watermelon Slice",2,"Watermelon","Watermelon Slice",1000,["メロン農家"])
  addSkill(skillTree,"コーン農家","Maple Log",3,"Corn","Corn",1000,["ビートルート農家"])
  addSkill(skillTree,"さくらんぼ農家","Cherry",3,"Cherry","Cherry",1000,["prestage"])
  addSkill(skillTree,"すもも農家","Plum",3,"Plum","Plum",1000,["prestage"])
  addSkill(skillTree,"マンゴー農家","Mango",3,"Mango","Mango",1000,["バナナ農家"])

  addSkill(skillTree,"石に愛された者","Messy Stone",5,"Mega Complessed Messy Stone","Messy Stone",8000,["prestage"])
  addSkill(skillTree,"毒きのこがお好き?","Red Mushroom",3,"Red Mushroom","Red Mushroom",1000,["prestage"])
  addSkill(skillTree,"ロードローラー","Dirt",5,"Diamond Spade","Dirt",8000,["prestage"])
  addSkill(skillTree,"じゃがいも農家","Raw Potato",3,"Raw Potato","Raw Potato",1000,["prestage"])
  addSkill(skillTree,"メロン農家","Melon Slice",3,"Melon","Melon Slice",1000,["かぼちゃ農家"])
  addSkill(skillTree,"ビートルート農家","Beetroot",3,"Beetroot","Beetroot",1000,["prestage"])
  addSkill(skillTree,"バナナ農家","Banana",3,"Banana","Banana",1000,["prestage"])

  addSkill(skillTree,"かぼちゃ農家","Pumpkin",5,"Pumpkin","Pumpkin",1000,["prestage"])
